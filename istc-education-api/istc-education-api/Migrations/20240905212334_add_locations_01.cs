...
{
    /// <inheritdoc />
    public partial class add_locations_01 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locations_Courses_CourseId",
                        column: x => x.CourseId,
